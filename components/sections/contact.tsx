    ...
    <section id="contact" className="py-16 sm:py-20 lg:py-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          ...
          <div className="w-20 h-1 bg-primary mx-auto rounded-full mb-5 sm:mb-6" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-10 sm:gap-12">
          ...
          <div className="lg:col-span-2 space-y-7 sm:space-y-8">
                ...
                <CardContent className="p-4 flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <a
                      ...
                      className="font-medium text-foreground text-sm sm:text-base truncate block transition-colors hover:text-primary"
                    >
                      {profile.email ?? "—"}
                    </a>
                  </div>
            ...
            <div>
              <h4 className="text-sm font-semibold text-foreground mb-3 sm:mb-4 uppercase tracking-wide">
                Follow Me
              </h4>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select name="projectType">
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="illustration">Illustration / Art</SelectItem>

...
export default function AdminLayoutClient({
  ...
  // Reset navigating state when pathname actually changes
  // useEffect(() => {
  //   setNavigating(null)
  // }, [pathname])
  ...
  const isActive = pathname === item.href || (navigating === item.href && navigating !== pathname)
  return (
    <Link
      key={item.href}
      href={item.href}
...
//         <div className="p-4 sm:p-6 lg:p-8">{children}</div>
//       </main>
//       {/* Progress bar - sits at root level, renders as a portal */}
//       <ProgressBar
//         height="3px"
//         color="hsl(var(--primary))"
//         options={{ showSpinner: false }}
